...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{images/replay_alert.png}
...
Nếu hệ thống có chèn bộ đếm ở byte cuối, khung bị phát lại sẽ giữ nguyên giá trị bộ đếm cũ.
Điều này giúp giải thích vì sao phía nhận có thể sinh cảnh báo \texttt{REPLAY suspected} do
trùng lặp dữ liệu hoặc do sai lệch chuỗi bộ đếm giữa các lần xuất hiện của cùng một CAN ID.

\IfFileExists{images/replay_defend.png}{%
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{images/replay_defend.png}
...
\reportsection{III. Video minh họa các kịch bản}
